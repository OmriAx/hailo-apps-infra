...
class GStreamerDetectionApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        if self.options_menu.input is None:  # Setting up a new application-specific default video (overrides the default video set in the GStreamerApp constructor)
            self.video_source = "/home/hailo/omria/csg-145/hailo-apps-infra/lpr_test.mp4"
        if self.options_menu.hef_path is not None:
            self.hef_path = self.options_menu.hef_path
        else:
            self.hef_path = "/usr/local/hailo/resources/models/hailo8/yolov8s.hef"
        ...
        self.labels_json = "/home/hailo/omria/hailo-apps-infra/resources/json/yolov5_vehicle.json"
