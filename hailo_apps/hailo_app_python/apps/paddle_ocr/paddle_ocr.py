...
class GStreamerOCRApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        self.post_process_so =  "/usr/local/hailo/resources/so/libtest_postprocess.so" #get_resource_path(OCR_PIPELINE,RESOURCES_SO_DIR_NAME,OCR_POSTPROCESS_SO_FILENAME)

        self.det_post_function = "db_postprocess" #OCR_DET_POSTPROCESS_FUNCTION
    ...
    def get_pipeline_string(self):  
        ...
        # user callback and display for detection visualization  
        ...
        return f"{source} ! {det_wrapper} ! {callback} ! {display}"
